<template>
  <s-filter-drawer @filter="refresh">
    <v-switch v-model="specification.activeOnly" :label="$t('show-active-only')" hide-details
      @update:model-value="refresh"></v-switch>
    <WorkflowProcessDefinition v-model="specification.name" density="compact" variant="solo-filled" flat hide-details
      clearable></WorkflowProcessDefinition>
