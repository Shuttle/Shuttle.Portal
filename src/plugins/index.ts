...
import ShuttleDateRangeFilter from "@/components/ShuttleDateRangeFilter.vue";
...
import ShuttleMaximumRows from "@/components/ShuttleMaximumRows.vue";
...
export function registerPlugins(app: App) {
  ...
  app.component("s-date-range-filter", ShuttleDateRangeFilter);
  ...
  app.component("s-maximum-rows", ShuttleMaximumRows);
